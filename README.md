# [Download](https://drive.google.com/file/d/1dm2P_RtMx5MzwlPg3tKTNRZ7rcgBwu0B/view?usp=sharing)
...
- Separate textures for hit beams, with a new state for hits that are within half of your critical window (think S-CRITICAL)
  - There is a setting under the `Visual` tab to toggle this feature
  - If your skin does not have the necessary files, they will be loaded from `skin_fallback`
